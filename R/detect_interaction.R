#' Detect Pairwise Interactions from a Shapley Forest Object
#'
...
detect_interaction <- function(object, thresh = 0, all = FALSE,
  ...
  if (is.null(int_mat) || !is.matrix(int_mat))
    stop(paste0(
      "No interaction matrix found in this shapley_forest object.\n",
      "  Refit with sf() — interaction values are computed automatically ",
